...
export const NEW_ADDRESS_CHECKOUT_CASES: CheckoutCase[] = [
    {
        description: 'Checkout with new US addresses | Ground shipping | Cash On Delivery',
        billingAddress: US_BILLING_ADDRESS,
        shippingAddress: US_SHIPPING_ADDRESS,
        shippingMethod: 'Ground (0.00)',
        paymentMethod: 'Cash On Delivery (COD) (7.00)',
        expectedPaymentInfo: 'You will pay by COD',
        expectedOrderSummary: {
        ...
        expectedBillingInfo: {
            name: `${US_BILLING_ADDRESS.fisrtName} ${US_BILLING_ADDRESS.lastName}`,
            email: US_BILLING_ADDRESS.email,
            phone: US_BILLING_ADDRESS.phoneNumber,
            address: US_BILLING_ADDRESS.address1,
            country: US_BILLING_ADDRESS.country,
            paymentMethod: 'Cash On Delivery (COD)',
        },
        expectedShippingInfo: {
            name: `${US_SHIPPING_ADDRESS.fisrtName} ${US_SHIPPING_ADDRESS.lastName}`,
            email: US_SHIPPING_ADDRESS.email,
            phone: US_SHIPPING_ADDRESS.phoneNumber,
            address: US_SHIPPING_ADDRESS.address1,
            country: US_SHIPPING_ADDRESS.country,
            shippingMethod: 'Ground',
        },
    },
    {
        description: 'Checkout with new EU addresses | Ground shipping | Cash On Delivery',
        billingAddress: EU_BILLING_ADDRESS,
        shippingAddress: EU_SHIPPING_ADDRESS,
        shippingMethod: 'Ground (0.00)',
        paymentMethod: 'Cash On Delivery (COD) (7.00)',
        expectedPaymentInfo: 'You will pay by COD',
        expectedOrderSummary: {
        ...
        expectedBillingInfo: {
            name: `${EU_BILLING_ADDRESS.fisrtName} ${EU_BILLING_ADDRESS.lastName}`,
            email: EU_BILLING_ADDRESS.email,
            phone: EU_BILLING_ADDRESS.phoneNumber,
            address: EU_BILLING_ADDRESS.address1,
            country: EU_BILLING_ADDRESS.country,
            paymentMethod: 'Cash On Delivery (COD)',
        },
        expectedShippingInfo: {
            name: `${EU_SHIPPING_ADDRESS.fisrtName} ${EU_SHIPPING_ADDRESS.lastName}`,
            email: EU_SHIPPING_ADDRESS.email,
            phone: EU_SHIPPING_ADDRESS.phoneNumber,
            address: EU_SHIPPING_ADDRESS.address1,
            country: EU_SHIPPING_ADDRESS.country,
            shippingMethod: 'Ground',
        },
    },
];
